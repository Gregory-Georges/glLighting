...
////////////////////////////////////////////
    ...
    void Camera::addPitch(double deg)
    {
        ...
        //Protect pitch from going too high or too low
        if(pitch >= 90.0)
            pitch = 89.99;
        else if(pitch < -89.99)
            pitch = -89.99;
    ...
    void Camera::addYaw(double deg)
    {
        ...
        //Reset yaw value if too high or to low
    ...
    void Camera::addRoll(double deg)
    {
        ...
        //Reset roll value if too high or too low
    ...
    void Camera::addFoV(float vFoV)
    {
        ...
        //Protect FOV from getting too high or too low
        if(FoV > 45.0)
            FoV = 45.0;
        else if(FoV < 1.0)
            FoV = 1.0;
